...
ssh luna.mines.edu 'tar -xvzf /srv/csci_445/2013_fall/team10/crowdsource.tar.gz -C /srv/csci_445/2013_fall/team10; rm -f /srv/csci_445/2013_fall/team10/crowdsource.tar.gz'
